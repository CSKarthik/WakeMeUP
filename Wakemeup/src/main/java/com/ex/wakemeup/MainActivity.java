...
public class MainActivity extends FragmentActivity implements
    ...
    /**
     * Invoked by the Set alarm button.
     */
    public void setAlarm(View v){

        EditText lat = (EditText)findViewById(R.id.editText);
        EditText lon = (EditText)findViewById(R.id.editText2);
        double latval = Double.parseDouble(lat.getText().toString());
        double lonval = Double.parseDouble(lon.getText().toString());
        checkIfReached(latval,lonval);
    }

    public void checkIfReached(Double lat , Double lon)
    {
        if(servicesConnected()) {
            Location currentLocation = mLocationClient.getLastLocation();
            Double dist = getDistanceInMeters(currentLocation.getLatitude(),currentLocation.getLongitude(),lat,lon);
            ...
            if(alarm != null){
                alarm.SetAlarm(context,lat,lon,currentLocation.getLatitude(),currentLocation.getLongitude());
            }else{
